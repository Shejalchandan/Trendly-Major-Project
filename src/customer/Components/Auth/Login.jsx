...
export default function LoginUserForm({ handleNext }) {
  ...
  useEffect(()=>{
    ...
    useEffect(() => {
      if (auth.user) {
        ...
        navigate("/home"); // Replace "/dashboard" with your desired path
      }
      if (auth.error) setOpenSnackBar(true);
  ...
  return (
    <React.Fragment className=" shadow-lg ">
      ...
      {/* <div className="flex justify-center flex-col items-center">
        <div className="py-3 flex items-center">
          <p className="m-0 p-0">Forgot your password?</p>
          <Button onClick={()=> navigate("/forgot-password")} className="ml-5" size="small">
          Reset Password
        </Button>
        </div>
      </div> */}
