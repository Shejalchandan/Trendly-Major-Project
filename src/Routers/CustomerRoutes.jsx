...
import ForgotPasswordForm from "../customer/Components/Auth/ForgotPasswordForm";
import PasswordResetForm from "../customer/Components/Auth/PasswordResetForm";
  ...
  return (
    ...
    {showNavigation && <Navigation />}
     ...
     <Route path="/register" element={<Homepage />}></Route>
        ...
        <Route path="/payment/:orderId" element={<OrderDetails />}></Route>
